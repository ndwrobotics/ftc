...
@Autonomous(name="3V2 Glyph -Blue Mat Right", group="Autonomous")
//@Disabled
public class Auto3V2BlueMatRight extends LinearOpMode
{
    ...
    public void runOpMode() {
        ...
        bot.encoderDrive(-32.5);// -17.5 or -25 or -32.5
        bot.encoderTurn(-60);
        bot.encoderDrive(12);
